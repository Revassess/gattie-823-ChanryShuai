...
public class ConnectionUtil {
	...
	// add your jdbc url
	public static final String URL = "jdbc:postgresql://javafs200803.cavdq4fumkzs.us-east-1.rds.amazonaws.com:5432/destdb";
	// add your jdbc username
	public static final String USERNAME = "postgress";
	// add your jdbc password
	public static final String PASSWORD = "password";
	// name of the created stored procedure in tier 3
	public static final String TIER_3_PROCEDURE_NAME = "trigger_set_time()";
	// name of the created sequence in tier 3
	public static final String TIER_3_SEQUENCE_NAME = "tier3";
